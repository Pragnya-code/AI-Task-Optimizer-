...
if __name__ == '__main__':
    ...
    print("="*60)
    print("\n🌐 Website Pages:")
    print("   📍 Home: http://localhost:7860/")
    print("   📍 Projects: http://localhost:7860/projects")
    print("   📍 Demo: http://localhost:7860/demo")
    print("   📍 Documentation: http://localhost:7860/documentation")
    print("   📍 References: http://localhost:7860/references")
    print("   📍 About: http://localhost:7860/about")
    print("="*60 + "\n")
